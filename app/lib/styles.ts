export const STYLES = {
  ...
  section: "mt-12",
  sectionPlain: "mt-12 rounded-3xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-6 py-8 shadow-[6px_6px_0_var(--color-primary-dark)] md:px-8 md:py-10",
  sectionAlt: "mt-12 rounded-3xl border border-[color:var(--color-border)] bg-[color:var(--color-background-alt)] px-6 py-8 shadow-[6px_6px_0_var(--color-primary-dark)] md:px-8 md:py-10",
  sectionWarm: "mt-12 rounded-3xl border border-[color:var(--color-border)] bg-[color:var(--color-sand)] px-6 py-8 shadow-[6px_6px_0_var(--color-primary-dark)] md:px-8 md:py-10",
  ...
  buttonPrimary:
    "inline-flex items-center justify-center rounded-xl border border-[color:var(--color-primary)] bg-[color:var(--color-primary)] px-6 py-3 font-[family-name:var(--font-display)] text-[16px] font-semibold text-[color:var(--color-surface)] shadow-[4px_4px_0_var(--color-primary-dark)] transition-colors duration-150 hover:bg-[color:var(--color-primary-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-primary)] focus-visible:ring-offset-2",
  buttonSecondary:
    "inline-flex items-center justify-center rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-6 py-3 font-[family-name:var(--font-display)] text-[16px] font-semibold text-[color:var(--color-primary-dark)] shadow-[4px_4px_0_var(--color-border)] transition-colors duration-150 hover:border-[color:var(--color-primary)] hover:text-[color:var(--color-primary-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-primary)] focus-visible:ring-offset-2",
  input:
  ...
  communityCard:
    "rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-6 shadow-[6px_6px_0_var(--color-primary-dark)]",
  ...
  segmented:
    "inline-flex rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-1 shadow-[4px_4px_0_var(--color-primary-dark)]",
  segment:
    "rounded-lg px-6 py-2.5 font-[family-name:var(--font-display)] text-[16px] font-semibold transition-colors duration-200",
  segmentActive:
    "bg-[color:var(--color-primary)] text-[color:var(--color-surface)] shadow-[2px_2px_0_var(--color-primary-dark)]",
  segmentInactive:
