export const STYLES = {
  ...
  section: "mt-12",
  sectionPlain: "mt-12 rounded-3xl bg-[color:var(--color-surface-primary)] px-6 py-10 md:px-8 md:py-12",
  sectionAlt: "mt-12 rounded-3xl bg-[color:var(--color-surface-secondary)] px-6 py-10 md:px-8 md:py-12",
